<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::model($book, [
        ...
        'class' => 'form-horizontal'
            ...
            <div class="form-group <?php echo e($errors->has('published_on') ? 'has-error' : ''); ?>">
                <?php echo Form::label('published on', 'Published On: ', ['class' => 'col-sm-3 control-label']); ?>

                <div class="col-sm-6">
                    <?php echo Form::date('published_on', null, ['class' => 'form-control']); ?>

                    <?php echo $errors->first('published_on', '<p class="help-block">:message</p>'); ?>
